...
function log( log_object ){
  ...
  var logsHTML = $("#logs-panel .card-content").html();
    $("#logs-panel .card-content").html("<div class='log-item'>\
        <span class='log-date'>" + time + "</span><p class='" + log_object.color + "'>" + log_object.message + "</p></div>" + logsHTML);
